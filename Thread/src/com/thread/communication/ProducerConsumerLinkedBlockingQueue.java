...
class Producer1 implements Runnable {
	...
	public Producer1(BlockingQueue<String> queue1, BlockingQueue<String> queue2) {
		this.queue1 = queue1;
		this.queue2 = queue2;
	}
...
class Consumer1 implements Runnable {
	...
	public Consumer1(BlockingQueue<String> queue1, BlockingQueue<String> queue2) {
		this.queue1 = queue1;
		this.queue2 = queue2;
	}
...
public class ProducerConsumerLinkedBlockingQueue {
	...
	public static void main(String[] args) {
		...
		Thread producer = new Thread(new Producer1(queue1, queue2), "Producer-Thread");

		Thread consumer = new Thread(new Consumer1(queue1, queue2), "Consumer-Thread");
