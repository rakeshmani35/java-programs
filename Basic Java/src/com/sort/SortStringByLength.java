...
public class SortStringByLength {
	...
	private static void sortStringByLengthUsingJava8Comparator(String str) {
		...
		//asList.stream().sorted(compByLength).forEach(p -> System.out.print(p + " "));
		Arrays.stream(s).sorted(compByLength).forEach(p -> System.out.print(p + " "));
	...
	private static void sortStringByLengthByNativeApproach(String str) {
	...
	public static void main(String[] args) {
		...
		System.out.println("Sort String By Length using java8 Comparator : ");
		...
		// ------------------Sort String By Length using Native Approach
		System.out.println("sort String By Length Using Native Approach : ");
		sortStringByLengthByNativeApproach(str);
	}
